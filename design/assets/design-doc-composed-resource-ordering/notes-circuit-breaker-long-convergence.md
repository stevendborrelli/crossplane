...
ordering, and `design/design-doc-composed-resource-ordering.md` records the
finding under "Open Design Questions" without the reproduction or the
suggested directions. Delete this file once the issue is filed.
