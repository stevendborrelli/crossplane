...
proposal) and `notes-implementation-kickoff-ordering.md` (where the code lives
...
* **This isn't an automated test yet.** These are manifests and manual steps.
  See the end-to-end section of `notes-implementation-kickoff-ordering.md` for
  what turning them into a real e2e requires.
